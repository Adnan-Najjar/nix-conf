...
main() {
    ...
    sudo apt install -y --no-install-recommends ubuntu-desktop-minimal network-manager bluetooth
    sudo apt install -y gnome-shell-extensions gnome-shell-extension-gsconnect gnome-tweaks gnome-sushi qalculate-gtk gnome-disk-utility exfatprogs fonts-noto-color-emoji
    ...
    cp ./setup/01-emoji.conf ~/.config/fontconfig/conf.d/
